...
public enum ErrorCode {
    ...
    UNSUPPORTED_INPUT_DIMS(18),
    SAME_NAMED_PARAMETER_ALREADY_EXIST(19),
    SAME_NAMED_ATTRIBUTE_ALREADY_EXIST(20),
    INVALID_BACKEND_CONFIG_ERROR(21),
    INPUT_NOT_FOUND_ERROR(22),
    OUTPUT_NOT_FOUND_ERROR(23);
